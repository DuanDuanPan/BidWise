...
| **Annotation Service（批注服务）** | 生成、对抗、协作、成本审批、编辑器 | **独立架构组件**（非编辑器子模块）。承载 6 种语义（AI 建议/评分预警/对抗反馈/人工批注/跨角色指导/待决策），支持双向流动（AI↔人、人↔人）。编辑器、对抗引擎、评分引擎、成本模块均通过 Annotation Service 发布和订阅批注 |
  ...
  "annotations": [
    {
      ...
      "type": "ai-suggestion | score-warning | adversarial | human | cross-role | pending-decision",
      "content": "...",
      "author": "agent:adversarial-expert | user:liwork",
