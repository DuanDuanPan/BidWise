...
export function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="text-body-small mb-3 text-gray-400">{proposalLabel}</div>
      ...
      <div className="text-body-small mb-2 flex items-center justify-between text-gray-500">
        ...
        <span
          ...
          style={deadline.isUrgent ? { color: 'var(--color-warning)' } : undefined}
        >
      ...
      {/* Compliance row */}
      <div className="text-body-small mb-2 flex items-center justify-between text-gray-400">
        <span>合规状态</span>
        <span>待检查</span>
      </div>
      ...
      {/* Recent activity */}
      <div className="text-body-small flex items-center gap-1 text-gray-400">
