...
describe('classifyCertaintyPrompt', () => {
  ...
  const mockTenderSections: TenderSection[] = [
    { id: 'sec-001', title: '投标须知', content: '投标须知内容', pageStart: 1, pageEnd: 5, level: 1 },
    { id: 'sec-002', title: '技术要求', content: '技术要求内容', pageStart: 6, pageEnd: 20, level: 1 },
    { id: 'sec-003', title: '商务条款', content: '商务条款内容', pageStart: 21, pageEnd: 30, level: 1 },
  ]
