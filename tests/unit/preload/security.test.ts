...
describe('preload security isolation (AC-2, AC-5)', () => {
  ...
  it('only exposes whitelisted API methods', () => {
    const allowedMethods = new Set([
      ...
      'chapterStructureList',
      'chapterStructureGet',
      'chapterStructureTree',
      'chapterStructurePath',
      'chapterStructureUpdateTitle',
      'chapterStructureInsertSibling',
      'chapterStructureInsertChild',
      'chapterStructureIndent',
      'chapterStructureOutdent',
      'chapterStructureMoveSubtree',
      'chapterStructureSoftDelete',
      'chapterStructureUndoDelete',
